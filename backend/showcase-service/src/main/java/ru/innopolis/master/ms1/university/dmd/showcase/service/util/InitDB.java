...
public class InitDB {
    ...
    public static final Group[] GROUPS = {
            ...
            new Group(3, "PartyMakers#3", LocalDate.now(), "Free", PICTURES[15]),
            new Group(4, "PartyMakers#4", LocalDate.now(), "Free", PICTURES[15]),
            new Group(5, "PartyMakers#5", LocalDate.now(), "Free", PICTURES[15]),
            new Group(6, "PartyMakers#6", LocalDate.now(), "Free", PICTURES[15]),
    };
